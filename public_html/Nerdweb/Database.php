...
namespace Nerdweb {
    ...
    class Database {
        ...
        public function updatePrepared($tblname, array $datafields, array $updateValues, array $condFields, array $condValues) {
            ...
            $condFields = array_values($condFields);

            $condValues = array_values($condValues);
            ...
            $sql = "UPDATE $tblname SET " . implode("=? ", $datafields) . "=? WHERE " . $conditions . $sufixQuery;
